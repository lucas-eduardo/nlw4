defmodule Rocketpay.Accounts.Operation do
  ...
  def call(%{"id" => id, "value" => value}, operation) do
    operattion_name = account_operation_name(operation)
    Multi.new()
      |> Multi.run(operattion_name, fn repo, _changes -> get_account(repo, id) end)
      |> Multi.run(operation, fn repo, changes ->
        account = Map.get(changes, operattion_name)
